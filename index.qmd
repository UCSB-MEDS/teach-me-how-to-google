...
[**[{{< fa file-lines title="a file with lines" >}}]{.teal-text} Documentation**]{.body-text-m}
...
[{{< fa file-lines >}} Documentation]{.slide-title}
...
- **Read books!** [R for Data Science (2e)](https://r4ds.hadley.nz/){target="_blank"} is *the* primer for all things R for data science (also see [Python for Data Analysis (3e)](https://wesmckinney.com/book/){target="_blank"}). Reading introduces you to important terminology and concepts that make Googling help a whole lot easier 
