...
[*The case for search & debugging skills in the age of AI + tips on how to do so effectively*]{.custom-subtitle2}
...
[Other related findings]{.slide-title}
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("images", "pivot_wider_doc.png"))
```
:::
::::
<!-- ::: {.footer}
The documentation that appears in the Help pane is the same that you'll find in the official documentation online.
::: -->
...
(Unofficial) tutorials and GenAI tend to provide easy / fast approaches or fixes to a problem, but often may lead to difficulties in scaling or lack of nuanced understanding.
...
::: {.footer}
[CRAN](https://cran.r-project.org/){target="_blank"} stands for the **C**omprehensive **R** **A**rchive **N**etwork and is R's central software repository -- in other words, it's where published R packages (including previous versions of published R packages) live. When you run `install.packages("package_name)`, R (on your computer) reaches out to CRAN to find / install the latest version of that package on your computer.
:::

---

## {#talk-out-loud data-menu-title="Talk out loud"}
...
[Quack! Configuring Large Language Models to Serve as Rubber Duck Coding Assistants](https://dl.acm.org/doi/pdf/10.1145/3641555.3705235?casa_token=g_V2W5f2vtgAAAAA:reTmZlZx14O-vZJEnACFGId9Cr_Gt1lOtQr2X4YKQdhiG3Jb6qzcV5Qr-Sqfs66h6spIXtEsabIF){target="_blank"}

---

## {#enter-google data-menu-title="Enter Google"}

[Still haven't figured it out? Enter Google.]{.slide-title}
...
- [past solutions can become outdated quickly -- target recent posts and responses (also an issue when using GenAI!)]{.body-text-s}
...
**{{< fa brands github-square title="GitHub Octocat" >}} Explore package source code on GitHub:**

- [this may include looking at any issues or pull requests associated with that package to check if there are known problems (e.g. check out ___ on [GitHub](){target="_blank"})]{.body-text-s}
