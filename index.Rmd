...
library(metathis)
meta() %>%
  meta_name("github-repo" = "UCSB-MEDS/teach-me-how-to-google") %>%
  meta_social(
    title = "Teach Me How to Google",
    description = paste(
    ...
    image_alt = paste(
      "Title of slide reads 'Welcome to data science, where questions are aplenty' followed by three bullets:",
      "First bullet: 'You will become increasingly more comfortable with not immediately knowing the answers to all your coding problems. It's all part of the job.'",
      "Second bullet: 'If it's not already, Google will become one of your best friends.'",
      "Third bullet: 'Googling is hard, and it is a skill that requries practice. But you can and will get better at it over time.'",
      "On the right hand side of the slide is a gif of Seth Meyers, form the Late Night, saying 'I have a lot of questions'"
    ),
    og_type = "website",
...
<span style = 'font-size: 130%;'>Master of Environmental Data Science | Fall 2021</span>   
