...
<span style = 'font-size: 75%;'>Access the documentation for any loaded package or function by either typing `?function_name` or `help(function_name)` in your console. If you search for a package that is not currently loaded, R will prompt you to type `??function_name`.</span>
