...
<p style = 'font-size: 75%;'>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` **What is it?** [ChatGPT](https://chat.openai.com/auth/login) is an artificial intelligence (AI) chat bot developed by [OpenAI](https://openai.com/) that uses natural language processing (NLP) to generate responses to user-generated prompts.</span>

--

<!-- <p style = 'font-size: 65%;'>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` **Why is everyone so exited about it?** ChatGPT can be a powerful tool to help increase productivity and efficiency, but it's important to consider using it responsibly and ethically</span> -->

--

<p style = 'font-size: 65%;'>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` **Why would I want to use Google over ChatGPT?**</span>

--

`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` **Should I be scared of it replacing jobs?** Short answer, no.

- ChatGPT only uses data up to 2021
...
- Programming or developing is more than just coding. ChatGPT may be good at generating codes but still lacks problem-solving abilities. Read what experts think about it.
- ChatGPT can augment / assist 
