...
<span style = 'font-size: 75%;'>It's not uncommon to confuse or mistake function names, particularly as you're just starting to learn a language or new packages. For example, a similarly named function, `forcats::fct_reorder()`, is used to reorder *factor* levels. In this case, however, we're looking to reorder *numeric values* in the `bill_length_mm` column.</span>
