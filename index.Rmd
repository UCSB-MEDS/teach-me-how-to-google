...
<span style = 'font-size: 120%;'>`r fontawesome::fa("github-square", fill = "#05859B", a11y = "sem")`  Explore package source code on GitHub</span>
  ...
  - <span style = 'font-size: 100%;'>this may include looking at any issues or pull requests associated with that package to check if there are known problems</span>
