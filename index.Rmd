...
<span style = 'font-size: 130%;'>Master of Technology Management | Winter 2022</span>   
...
**Goal:** Determine why the running following code returns an error.
...
library(tidyverse) #<< 
# or import the {dplyr} or {magrittr} pkgs (both part of the tidyverse)
library(palmerpenguins)
