...
<span style = 'font-size: 70%;'>Some packages will also have **vignettes**, which provide more detailed descriptions and examples of how functions within a package should be used. Googling `package_name vignette` will usually get you there (e.g. check out the [dplyr vignette](https://cran.r-project.org/web/packages/dplyr/vignettes/dplyr.html)). Alternatively, package documentation on [CRAN](https://cran.r-project.org/) will typically include any vignettes that are associated with that package (e.g. find all dplyr vignettes [here](https://cran.r-project.org/web/packages/dplyr/index.html)).</span>
