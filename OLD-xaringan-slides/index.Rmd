...
- <span style = 'font-size: 80%;'>**Programming/developing is more than just coding.** Reproducibility, intuitive organization, coming up with creative solutions for complex tasks, etc. requires contextual understanding and critical thinking. ChatGPT isn't a replacement for this.</span>
...
convert_temp <- function(from, to, temp) {
  ...
  if(from == "celsius" & to == "fahrenheit") {
    ...
    # if inputs don't match either of the first two conditionals, return error & NA 
  } else { #<<
